            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
                    <div className="max-w-7xl">
                        <h2 className="text-stone-950 text-3xl md:text-5xl font-bold font-['Poppins'] leading-tight mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
                    {features.map((feature) => (
                        <div
                            key={feature.id}
                            className="bg-white rounded-[15px] p-8 flex items-center gap-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-lg transition-all duration-300 border border-gray-50/50"
                        >
                            <div className="flex-shrink-0 size-16 rounded-full border border-gray-100 flex items-center justify-center bg-white shadow-inner">
                                {feature.icon}
                            </div>
                            <h3 className="text-stone-950 text-xl font-bold font-['Poppins'] leading-tight whitespace-pre-line">
                                {feature.title}
                            </h3>
                        </div>
                    ))}
                ...
                <div className="relative w-full">
                    <div className="relative rounded-[40px] overflow-visible group">
                        ...
                        <div className="absolute -top-12 md:-top-16 left-1/2 -translate-x-1/2 w-[95%] max-w-[800px] z-20">
                            <div className="bg-white/80 backdrop-blur-md p-2 rounded-full shadow-xl shadow-blue-500/10">
                                <div className="bg-[#1781FE] rounded-full px-6 py-4 md:px-12 md:py-6 flex items-center justify-between gap-6">
                                    <h4 className="text-white text-sm md:text-lg font-medium font-['Roboto'] leading-tight">
                                        Need to Help? Don’t Hesitate Friendly<br className="hidden md:block" /> Collaboarte with Experties
                                    </h4>

                                    <div className="flex items-center gap-3 md:gap-5">
                                        <div className="size-10 md:size-14 rounded-full bg-white flex items-center justify-center shadow-lg transition-transform group-hover:scale-110">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-stone-950">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-white text-[10px] md:text-sm font-medium font-['Roboto'] opacity-90">Need Help?</span>
                                            <a href="tel:+91345533865" className="text-white text-base md:text-2xl font-bold font-['Poppins'] tracking-tight leading-none">
                                                +91 345 533 865
                                            </a>
                                        </div>
                                    </div>
                        ...
                        {/* Banner Image */}
                        <div className="relative w-full aspect-[2/1] md:aspect-[1232/580] rounded-[40px] md:rounded-[60px] overflow-hidden shadow-2xl border-4 border-white/50">
                            <img
                                src={backgroundImage}
                            ...
                            <button
                                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 md:size-28 bg-[#1781FE] rounded-full flex items-center justify-center text-white shadow-[0_0_60px_rgba(23,129,254,0.4)] transition-all duration-500 hover:scale-110 active:scale-95 group/play z-10"
                            >
