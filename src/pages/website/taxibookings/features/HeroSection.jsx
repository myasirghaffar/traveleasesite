    ...
    return (
        <section className="relative w-full lg:w-[94%] mx-auto rounded-[45px] overflow-hidden min-h-[500px] lg:min-h-[530px] flex items-center justify-center">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center px-4 -translate-y-2">
                <h1 className="text-white text-3xl md:text-5xl font-extrabold font-['Poppins'] leading-tight text-center max-w-[900px] mb-6 drop-shadow-lg">
                    Reliable Taxi Services for Your Every Journey
                </h1>
                <p className="text-white text-lg md:text-xl font-medium lg:font-semibold font-['Roboto'] leading-7 text-center max-w-[700px] drop-shadow-md">
